...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "dGVjaG5vaGFsbC5xdWVyaWVzQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "cXdlcnR5QDEyMw==";
        const char* FROM = "technohall.queries@gmail.com";
