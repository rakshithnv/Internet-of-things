...
#define AIO_USERNAME    "thingsenz"
#define AIO_KEY         "45bbdd80842e49e9a4d1c67ccb077c66"
#define relay 12
...
pinMode(relay,OUTPUT);
  ...
  Serial.println("IP address: "); Serial.println(WiFi.localIP()); //this function returns IP address
